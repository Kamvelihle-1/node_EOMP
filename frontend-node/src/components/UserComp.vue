  ...
  export default {
      ...
      created(){
        for (user in this.users) {
            if (user.userID == this.data.userID){
                this.data.firstName = user.firstName,
                this.data.lastName= user.lastName,
                this.data.userAge= user.userAge,
                this.data.Gender= user.Gender,
                this.data.userRole= user.userRole;
                this.data.emailAdd= user.emailAdd;
                this.data.userPass= user.userPass,
                this.data.userProfile= user.userProfile;
            }

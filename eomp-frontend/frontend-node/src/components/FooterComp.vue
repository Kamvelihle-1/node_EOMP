    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-6">
          <img src="https://i.postimg.cc/02c4skss/Blue-Tech-Space-Mobile-Free-Logo.jpg" alt="" style="width: 200px;" class="rounded-5 ">
          <h6>About Us</h6>
          <p class="text-justify">
              At Tech Space we provide quality gadgets to our clients at an afforadble price, with authenciated online payments , great discounts and deliver our products safely.
          </p>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-sm-6 col-xs-12">
          <p class="copyright-text">Copyright &copy; 2023 All Rights Reserved by Tech Space.
          </p>
        </div>
